/* eslint-disable */
// Generated by Wrangler by running `wrangler types -e local --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 3cf6f090ab382be804dbc47a2a85895e)
// Runtime types generated with workerd@1.20251217.0 2025-11-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		INTERNAL_KV: KVNamespace;
		BUN_VERSION: "1.3.5";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUN_VERSION" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_API_TOKEN" | "VITE_BASE_URL" | "VITE_API_URL" | "VITE_RPC_URL" | "VITE_BETTER_AUTH_URL" | "BETTER_AUTH_SECRET">> {}
}
